...
//!   This version writes `BSTK\x00\x01\x09\x00` (0.1.9).  [`open`](BStack::open)
...
/// Full magic for files written by this version (`BSTK` + major 0 + minor 1 + patch 9 + 0).
const MAGIC: [u8; 8] = *b"BSTK\x00\x01\x09\x00";
