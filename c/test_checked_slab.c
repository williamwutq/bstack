...
static int test_foreign_slice_is_rejected(void)
{
    ...
    make_tmp(t2, sizeof t2);
    {
        ...
        checked_slab_bstack_allocator_t *a1 = checked_slab_bstack_allocator_new(b1, 64); CHECK(a1);
        checked_slab_bstack_allocator_t *a2 = checked_slab_bstack_allocator_new(b2, 64); CHECK(a2);
